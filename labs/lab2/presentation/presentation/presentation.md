...
Формула для выбора варианта: `(1132221814%70)+1` = 2 вариант.

## Выполнение лабораторной работы

Мы найдем два значения $x_1 = \dfrac{11.4}{5,1}$ и $x_2 = \dfrac{11.4}{3,1}$, задачу будем решать для двух случаев.
...
label = "Траекория движения катера")
```
...
plot!(ugol, x_lims, proj=:polar, lims=(0, 15),
 label = "Траекория движения лодки")
```
...
```Julia
# точное решение ДУ, описывающего движение катера 
# береговой охраны для 2 случая
